const perfumeHandData = [
  {
    ...
    prdImg: 'prd_hand_perfumehand_0.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_1.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_2.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_3.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_4.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_5.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_6.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_7.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_8.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_9.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_perfumehand_10.jpg',
...
const tubeHandData = [
  {
    ...
    summary:
      '바르는 순간 코 끝을 스치는 베르가못의 시원함, 수분을 머금은 흙을 연상시키는 패츌리와 무겁게 내려앉은 샌달우드는 갓 꺾은 야생화를 품에 가득 안았을 때 느껴지는 대지의 활기를 떠올리게 합니다.',
    prdImg: 'prd_hand_tubehand_0.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_1.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_2.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_3.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_4.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_5.jpg',
    detailImg: [
  ...
  },
  {
    ...
    prdImg: 'prd_hand_tubehand_6.jpg',
    detailImg: [
  ...
  },
  {
    ...
    summary:
      '열매 안에서 꽃을 피우는 무화과는 절제된 향취를 가집니다. 잎과 과육의 달콤 씁쓸함이 더해져 향은 더욱 풍부해지고, 엠브레트 씨앗과 엠버의 부드러운 조화는 깊이감 있는 여운을 남기며 향의 매력에 빠져들게 만듭니다.',
    prdImg: 'prd_hand_tubehand_7.jpg',
    detailImg: [
  ...
  },
  {
    ...
    summary:
      '가볍게 감싸는 월계수 잎과 은방울꽃의 깨끗함 뒤로, 정돈된 가죽 향이 약간의 긴장감을 선명하게 유지해 줍니다. 가죽의 무게감은 잔향의 머스크와 만나 눈부신 대조를 이루며 한층 부드러워진 맥박의 잔잔한 템포를 느끼게 합니다.',
    prdImg: 'prd_hand_tubehand_8.jpg',
    detailImg: [
  ...
  },
  {
    ...
    summary:
      '바르는 순간 코 끝을 스치는 베르가못의 시원함, 수분을 머금은 흙을 연상시키는 패츌리와 무겁게 내려앉은 샌달우드는 갓 꺾은 야생화를 품에 가득 안았을 때 느껴지는 대지의 활기를 떠올리게 합니다.',
    prdImg: 'prd_hand_tubehand_9.jpg',
    detailImg: [
...
const sanitizerData = [
  {
    ...
    summary:
      '열매 안에서 꽃을 피우는 무화과는 절제된 향취를 가집니다. 잎과 과육의 달콤 씁쓸함이 더해져 향은 더욱 풍부해지고, 엠브레트 씨앗과 엠버의 부드러운 조화는 깊이감 있는 여운을 남기며 향의 매력에 빠져들게 만듭니다.',
    prdImg: 'prd_hand_sanitizer_0.jpg',
  ...
  },
  {
    ...
    prdImg: 'prd_hand_sanitizer_1.jpg',
  ...
  },
  {
    ...
    summary:
      '잔잔한 꽃 향이 섞인 로즈우드와 라반딘의 정제되지 않은 야생화 본연의 향기에 코코넛의 달콤한 잔향이 어우러져 우아하고 매력적인 여운을 남깁니다.',
    prdImg: 'prd_hand_sanitizer_2.jpg',
  ...
  },
  {
    ...
    summary:
      '첫 향에서 느껴지는 부드럽고 매혹적인 오스만투스의 투명함과 짙게 남는 타바코의 퇴폐적인 향은 감각의 양면성이 가진 매력을 표현합니다. 순수와 퇴폐의 상반된 혼합은 새롭고 강렬한 아름다움을 선사합니다.',
    prdImg: 'prd_hand_sanitizer_3.jpg',
  ...
  },
  {
    ...
    summary:
      '열매 안에서 꽃을 피우는 무화과는 절제된 향취를 가집니다. 잎과 과육의 달콤 씁쓸함이 더해져 향은 더욱 풍부해지고, 엠브레트 씨앗과 엠버의 부드러운 조화는 깊이감 있는 여운을 남기며 향의 매력에 빠져들게 만듭니다.',
    prdImg: 'prd_hand_sanitizer_4.jpg',
  ...
  },
  {
    ...
    summary:
      '정지된 빛, 고양된 공기, 흙과 뿌리. 광활한 대지에서 느껴지는 고양된 공기와 그 안의 정지된 빛, 탬버린즈의 시그니처 향 000은 자연의 순환을 의미하는 흙과 뿌리의 깊고 차분한 움직임을 떠올리게 합니다.',
    prdImg: 'prd_hand_sanitizer_5.jpg',
